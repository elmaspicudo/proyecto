...
use acme\sitioBundle\Entity\comentarios;
use acme\sitioBundle\Form\comentariosType;
...
class comentariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sitioBundle:comentarios')->findAll();

        return $this->render('sitioBundle:comentarios:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('sitioBundle:comentarios:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sitioBundle:comentarios')->find($id);
        ...
        return $this->render('sitioBundle:comentarios:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('sitioBundle:comentarios:edit.html.twig', array(
            'entity'      => $entity,
