...
use acme\sitioBundle\Entity\blog;
use acme\sitioBundle\Form\blogType;
...
class blogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sitioBundle:blog')->findAll();

        return $this->render('sitioBundle:blog:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('sitioBundle:blog:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sitioBundle:blog')->find($id);
        ...
        return $this->render('sitioBundle:blog:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('sitioBundle:blog:edit.html.twig', array(
            'entity'      => $entity,
