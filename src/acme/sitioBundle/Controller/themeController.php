...
use acme\sitioBundle\Entity\theme;
use acme\sitioBundle\Form\themeType;
...
class themeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sitioBundle:theme')->findAll();

        return $this->render('sitioBundle:theme:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('sitioBundle:theme:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sitioBundle:theme')->find($id);
        ...
        return $this->render('sitioBundle:theme:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('sitioBundle:theme:edit.html.twig', array(
            'entity'      => $entity,
